            ...
            <motion.div
                ...
                {Array(6).fill('').map((item, index) => (
                    <motion.img
                        ...
                        className='rounded hover:scale-105 transition-all duration-300 cursor-pointer ' src={index % 2 === 0 ? assets.sample_img_1 : assets.sample_img_2} alt='' key={index} width={70} />
                ))}
            </motion.div>
